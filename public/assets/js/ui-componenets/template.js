   ...
   $('#blind-mode-1').click(function () {
    ...
    setTimeout(function() {
	  ...
	  $('#font-size-up').click(function(){   
			upSize= parseInt($('body').css('font-size')) + 1;
		if(upSize<=20)
			$('body').css('font-size', upSize);
		}); 
		$('#font-size-down').click(function(){   
			downSize= parseInt($('body').css('font-size')) - 1;
		if(downSize>=14)
			$('body').css('font-size', downSize);
		});
	});